const DESKTOP_IMAGE: &str = "";
...
async fn invoke(State(broker): State<Broker>, Json(body): Json<Value>) -> Json<Value> {
    ...
    assert!(matches!(
        ...
        Some("workspace.execute" | "desktop.control" | "*")
    ));
...
async fn swarm_dispatch_is_scoped_concurrent_durable_and_cancellable() -> Result<()> {
    ...
    let settings = RuntimeConfig {
        ...
        gateway: Some(Gateway {
            ...
            worker_capabilities: vec!["workspace.execute".into(), "desktop.control".into()],
        }),
    ...
    let desktop = super::desktop_tools::tools(
        service.core.clone(),
        scope.clone(),
        assistant,
        Some(a),
    ...
    assert!(!serde_json::to_string(&observed)?.contains(DESKTOP_IMAGE));
    let waited = desktop[0]
        .invoke(json!({"action":"wait","task_id":desktop_id}))
        .await?;
    assert_eq!(waited["result"]["content"][1]["data"], DESKTOP_IMAGE);
    assert!(
        desktop[0]
            .invoke(json!({"action":"wait","task_id":ids[0]}))
            .await
            .is_err()
    );
    drop(desktop);
